...
# import os
# n = [x for x in os.walk('C:\\CircleL')] # генератор списка
# print('генератор списка:', n.__sizeof__()) # -> генератор списка: 37192
# z = (y for y in os.walk('C:\\CircleL')) # выражение-генератор
# print('выражение генератор:', z.__sizeof__(), z) # -> выражение генератор: 184 <generator object <genexpr> at 0x00000121D5D29BE0>
#
#
...
# d2 = {k.capitalize(): int(v) for k, v in d.items()}
# print(d)
# print(d2)
...
# lst6 = [x * 4 for x in 'a1b2c3d4e5' if x.isdigit()]
# print('lst6:', lst6)
...
# lst2 = []
# #аналогичная запись без использования генератора
# for x in [2, 3, 4, 5]:
#     for y in [1, 2, 3]:
#         if y % 2 == 1:
#             lst2.append(x * y)
